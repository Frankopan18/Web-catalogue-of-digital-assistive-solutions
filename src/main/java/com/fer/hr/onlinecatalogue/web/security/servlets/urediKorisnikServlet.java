...
@WebServlet(urlPatterns = { "/urediKorisnik.jsp" })
public class urediKorisnikServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (a != null) {
			req.getRequestDispatcher("/WEB-INF/urediKorisnik.jsp").forward(req, resp);
		} else {
